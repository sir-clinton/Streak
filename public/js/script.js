...
let prefferedOption = localStorage.getItem('prefferedOption')
  ...
  if (cached && (Date.now() - cached.timestamp < cacheExpiry)) {
    ...
    // const allowedCities = ['Nairobi', 'Machakos', 'Kiambu'];
    // if (!allowedCities.includes(prefferedOption.city)) {
    //   submenu.innerHTML = '<p>City not available.</p>';
    //   return;
    // }
